...
import BudgetManagerPortal from '../budget-manager/BudgetManagerPortal';
    ...
    <div className="demo-portal-wrapper">
      <div className="demo-header" style={{ padding: '1rem 2rem', background: '#9C27B0', color: 'white' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h2 style={{ margin: 0 }}>Budget Manager Role Demo</h2>
            <p style={{ margin: '0.25rem 0 0 0', opacity: 0.9 }}>Budget tracking and cost forecasting</p>
          </div>
