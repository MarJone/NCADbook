/**
 * Capture "after" screenshots for style guide alignment audit
 * Run with: node scripts/capture-after-screenshots.js
 */
...
const OUTPUT_DIR = path.join(__dirname, '..', 'review', 'after-alignment');
...
async function captureScreenshots() {
  ...
  console.log('✨ AFTER screenshot capture complete!');
